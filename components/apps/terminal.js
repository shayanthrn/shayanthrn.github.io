...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["personal-documents", "languages", "Education", "interests"],
            Education: ["MASc-Electrical-and-Computer-Engineering-Concordia-University", "BS-Computer-Engineering-Amirkabir-Univesity-of-Technology"],
            interests: ["Software Engineering", "Cloud Computing", "DevOps", "IoT", "Deep Learning", "Computer Vision", "Audio Processing"],
            languages: ["Python", "TypeScript","Javascript", "C", "Java", "Kotlin", "English:)))", "Persian", "French(A1)"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">Shayan@HP</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/Shayan")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, subwaysurfer, chrome, about-Shayan, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
